import pygame
import time
def push(curX, curY, salle, debug, etat, wdw, porte, porte2):
    status=int
    #si dans la direction 0 alors bouger/return
    if etat == 1:
        if salle[curX+1, curY] == 0:
            curY, curX = curY, curX+1
            return curX, curY, status, porte, porte2
    if etat == 2:
        if salle[curX-1, curY] == 0:
            curY, curX = curY, curX-1
            return curX, curY, status, porte, porte2
    ...
    if etat == 1:
        if salle[curX+1, curY] == 2:
            status=check(curX, curY, salle, debug, etat, wdw, status, porte, porte2)
...
def check(curX, curY, salle, debug, etat, wdw, status, porte, porte2):
    if etat == 1:
        if salle[curX+1, curY] == 1 or salle[curX+1, curY] == 3 or salle[curX+1, curY] == 6:
            ...
            status=check(curX+1, curY, salle, debug, etat, wdw, status, porte, porte2)
            if debug == 1:
            ...
            if porte2 == 0:
                ...
                return status
    if etat == 2:
        if salle[curX-1, curY] == 1  or salle[curX-1, curY] == 3 or salle[curX-1, curY] == 6 or salle[curX-1, curY] == 9:
            status = 1
            return status
        elif salle[curX-1, curY] == 0 or salle[curX-1, curY] == 4 or salle[curX-1, curY] == 5:
            status = 0
            ...
            if porte2 == 0:
                ...
                return status
    if etat == 3:
        if salle[curX, curY-1] == 1 or salle[curX, curY-1] == 3 or salle[curX, curY-1] == 6 or salle[curX, curY-1] == 9:
            status = 1
            return status
            ...
            status=check(curX, curY-1, salle, debug, etat, wdw, status, porte, porte2)
            if debug == 1:
                print("La case devant est : {0}".format(salle[curX+1, curY]))
